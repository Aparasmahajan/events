...
const TEMPLATES = [
  ...
  { id: "nexus", code: "DEMO-NEXUS", type: "networking-event" },
  ...
  { id: "unveil", code: "DEMO-UNVEIL", type: "networking-event" },
  ...
  { id: "genesis", code: "DEMO-GENESIS", type: "networking-event" },
  ...
  { id: "secretlab", code: "DEMO-SECRETLAB", type: "networking-event" },
  { id: "portal", code: "DEMO-PORTAL", type: "networking-event" },
  { id: "evolution", code: "DEMO-EVOLUTION", type: "networking-event" },
  ...
  { id: "loom", code: "DEMO-LOOM", type: "wedding" },
  { id: "analog", code: "DEMO-ANALOG", type: "wedding" },
  { id: "locker", code: "DEMO-LOCKER", type: "birthday" },
  { id: "monsoon", code: "DEMO-MONSOON", type: "wedding" },
  { id: "courtyard", code: "DEMO-COURTYARD", type: "wedding" },
  { id: "spiceroute", code: "DEMO-SPICEROUTE", type: "wedding" },
  { id: "jaali", code: "DEMO-JAALI", type: "wedding" },
  { id: "popupbook", code: "DEMO-POPUPBOOK", type: "birthday" },
  { id: "speakeasy", code: "DEMO-SPEAKEASY", type: "birthday" },
  { id: "almanac", code: "DEMO-ALMANAC", type: "birthday" },
  { id: "manga", code: "DEMO-MANGA", type: "birthday" },
  { id: "matchday", code: "DEMO-MATCHDAY", type: "birthday" },
  { id: "feast", code: "DEMO-FEAST", type: "wedding" },
  { id: "panchang", code: "DEMO-PANCHANG", type: "wedding" },
  { id: "irani", code: "DEMO-IRANI", type: "wedding" },
  { id: "ludo", code: "DEMO-LUDO", type: "birthday" },
  { id: "tour", code: "DEMO-TOUR", type: "birthday" },
  { id: "newgame", code: "DEMO-NEWGAME", type: "birthday" },
  { id: "pitlane", code: "DEMO-PITLANE", type: "birthday" },
  { id: "handprint", code: "DEMO-HANDPRINT", type: "celebration-day" },
  { id: "mixtape", code: "DEMO-MIXTAPE", type: "celebration-day" },
  { id: "bloomday", code: "DEMO-BLOOMDAY", type: "celebration-day" },
];
...
const EVENT_TYPES_BY_TEMPLATE = {
  ...
  quantum: ["corporate", "networking-event"],
  neural: ["corporate", "networking-event"],
  genesis: ["corporate"],
  unveil: ["corporate"],
  nexus: ["corporate"],
  pinnacle: ["corporate"],
  ...
  quantumlab: ["corporate", "networking-event"],
  missioncontrol: ["corporate", "networking-event"],
  secretlab: ["networking-event"],
  portal: ["networking-event"],
  evolution: ["corporate"],
  ...
  loom: ["wedding", "engagement", "anniversary"],
  analog: ["wedding", "engagement", "anniversary"],
  locker: ["birthday", "party"],
  monsoon: ["wedding", "engagement", "anniversary"],
  courtyard: ["wedding", "engagement", "anniversary"],
  spiceroute: ["wedding", "engagement", "anniversary"],
  jaali: ["wedding", "engagement", "anniversary"],
  popupbook: ["birthday"],
  speakeasy: ["birthday", "party"],
  almanac: ["birthday"],
  manga: ["birthday", "party"],
  matchday: ["birthday", "party"],
  feast: ["wedding", "engagement", "anniversary"],
  panchang: ["wedding", "engagement", "anniversary"],
  irani: ["wedding", "engagement", "anniversary"],
  ludo: ["birthday", "party"],
  tour: ["birthday", "party"],
  newgame: ["birthday", "party"],
  pitlane: ["birthday", "party"],
  handprint: ["celebration-day"],
  mixtape: ["celebration-day"],
  bloomday: ["celebration-day"],
};
